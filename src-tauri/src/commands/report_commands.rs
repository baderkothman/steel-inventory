...
#[tauri::command]
pub fn get_monthly_profit_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_stock_movement_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_customer_debt_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_best_selling_products_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_cheapest_supplier_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_supplier_settlement_report(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
...
#[tauri::command]
pub fn get_supplier_settlement_summary(
    state: State<'_, AppState>,
    filters: ReportFilters,
) -> Result<Vec<Value>, AppError> {
    state.require_user_id()?;
