...
export const reportOptions = [
  ...
  { value: "stock_count", label: "Stock count (printable)" },
  { value: "stock_movement", label: "Stock movement" },
  { value: "low_stock", label: "Low stock" },
  { value: "cheapest_supplier", label: "Cheapest supplier comparison" },
  { value: "supplier_settlement", label: "Supplier settlement (sold goods)" },
  { value: "supplier_settlement_summary", label: "Supplier settlement summary" },
